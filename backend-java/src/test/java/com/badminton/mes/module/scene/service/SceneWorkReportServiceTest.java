...
class SceneWorkReportServiceTest {
    ...
    @Mock private SceneProductionTaskRepository taskRepository;
    ...
    void deviceAutoReportCreatesApprovedReportAndWageSnapshot() {
        ...
        processTask.setTaskStatus(SceneTaskStatusEnum.PENDING.getStatus());
        ...
        assertThat(processTask.getTaskStatus()).isEqualTo(SceneTaskStatusEnum.COMPLETED.getStatus());
        assertThat(task.getTaskStatus()).isEqualTo(SceneTaskStatusEnum.COMPLETED.getStatus());
