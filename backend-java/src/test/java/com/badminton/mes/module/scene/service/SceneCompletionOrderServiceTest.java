...
class SceneCompletionOrderServiceTest {
    ...
    @Mock private SceneProductionTaskRepository productionTaskRepository;
    ...
    void createAndApproveCompletionOrder() {
        ...
        SceneProductionTaskEntity productionTask = new SceneProductionTaskEntity();
        productionTask.setId(20L);
        productionTask.setWorkOrderId(10L);
        productionTask.setTaskStatus(SceneTaskStatusEnum.COMPLETED.getStatus());
        ...
        processTask.setTaskStatus(SceneTaskStatusEnum.COMPLETED.getStatus());
