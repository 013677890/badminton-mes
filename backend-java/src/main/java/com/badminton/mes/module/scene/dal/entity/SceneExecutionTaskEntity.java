...
/** 派工下发、设备报工和完工闭环使用的现场执行任务。 */
@Data
@Entity
@DynamicInsert
@Table(name = "scene_production_task")
public class SceneExecutionTaskEntity {
    @Id
    ...
    @Column(name = "task_status") private Integer taskStatus;
    @Column(name = "qualified_quantity") private BigDecimal qualifiedQuantity;
    @Column(name = "defect_quantity") private BigDecimal defectQuantity;
